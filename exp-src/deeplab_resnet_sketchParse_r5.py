...
class PoseModule(nn.Module):
    def __init__(self, inPlanes):
        ...
        init.normal_(self.PoseC1[0].weight, mean=0, std=0.01)
        init.constant_(self.PoseC1[0].bias, 0)
        init.normal_(self.PoseC1[2].weight, mean=0, std=0.01)
        init.constant_(self.PoseC1[2].bias, 0)
        init.normal_(self.PoseC1[4].weight, mean=0, std=0.01)
        init.constant_(self.PoseC1[4].bias, 0)
        init.normal_(self.PoseC2[0].weight, mean=0, std=0.01)
        init.constant_(self.PoseC2[0].bias, 0)
